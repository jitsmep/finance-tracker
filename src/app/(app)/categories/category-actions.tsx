...
export function CategoryActions({ categoryId, initialName = "", initialIcon = "📌" }: CategoryActionsProps) {
      ...
      <div className="flex items-center gap-1">
        <Dialog open={editOpen} onOpenChange={(val) => {
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <form onSubmit={(e) => {
            ...
            }} className="space-y-5 pt-2 border-t border-border mt-4">
              ...
              <div className="space-y-2">
                <Label htmlFor={`edit-cat-name-${categoryId}`}>Category Name</Label>
                <Input
                  id={`edit-cat-name-${categoryId}`}
                  name="name"
